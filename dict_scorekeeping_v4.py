...
score_dict = dict(Kinetic = kin.accuracy(), Gravitational = gra.accuracy(), Work = work.accuracy(), Power = powr.accuracy(), Voltage = volt.accuracy(), CircutPower = circ.accuracy(), HeatIncrease = h_inc.accuracy(), HeatChange = h_cha.accuracy())
